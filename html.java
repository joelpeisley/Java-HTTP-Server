...
import java.net.*;
/**
* A sample plugin that could handle html post requests.
* 
* @author Joel Peisley
* @version 1.0
* @since 14-11-2014
...
public class html {
        ...
        **/
        public html(String[] s, PrintWriter pw, Socket soc){
                pw.println("HTTP/1.0 200 OK");
                pw.println("");
                pw.println("<!DOCTYPE html><html><head><title>HTML Plugin</title></head><body>"
                        +"<h1>HTML Plugin Response</h1><p>The HTML Plugin recieved this POST message:"
                        +"<pre>");
                int i = 0;
